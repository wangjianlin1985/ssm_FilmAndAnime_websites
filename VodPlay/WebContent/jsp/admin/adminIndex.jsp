	...
	<body>
		<div class="container">
			<div class="container_wrap">
				...
				<div class="content">
					<div class="register">
						<div class="col-md-1 login-right" align="center">
						</div>
						<div class="col-md-2 login-right" align="center"style="border: 2px solid #FFF;">
							dada
						</div>
						<div class="col-md-8 login-right" align="center" style="border: 2px solid #FFF;">
							adasa
						</div>
						<div class="col-md-1 login-right" align="center">
						</div>
